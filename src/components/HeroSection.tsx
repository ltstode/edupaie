  ...
  return (
    <section className="py-20 md:py-28 relative">
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center space-y-8 text-center md:max-w-3xl md:mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3 min-[400px]:gap-4 animate-fade-in" style={{ animationDelay: "150ms" }}>
            <Link to="/register">
          ...
          <div className="flex flex-col mt-8 space-y-2 animate-fade-in" style={{ animationDelay: "300ms" }}>
